...
// indep_test_cpp
double indep_test_cpp(const std::vector<double>& x, const std::vector<double>& y, std::string method, const std::vector<double>& weights);
RcppExport SEXP _wdm_indep_test_cpp(SEXP xSEXP, SEXP ySEXP, SEXP methodSEXP, SEXP weightsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const std::vector<double>& >::type x(xSEXP);
    ...
    Rcpp::traits::input_parameter< const std::vector<double>& >::type weights(weightsSEXP);
    rcpp_result_gen = Rcpp::wrap(indep_test_cpp(x, y, method, weights));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_wdm_indep_test_cpp", (DL_FUNC) &_wdm_indep_test_cpp, 4},
    {NULL, NULL, 0}
};
